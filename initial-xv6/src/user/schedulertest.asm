...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	4a850513          	addi	a0,a0,1192 # 900 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 558:	00271793          	slli	a5,a4,0x2
 55c:	00000717          	auipc	a4,0x0
 560:	34c70713          	addi	a4,a4,844 # 8a8 <malloc+0x114>
 ...
 63e:	26690913          	addi	s2,s2,614 # 8a0 <malloc+0x10c>
        while(*s != 0){
