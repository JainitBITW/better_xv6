...
main(int argc, char *argv[]) {
  ...
  6a:	7ca50513          	addi	a0,a0,1994 # 830 <malloc+0xf2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	4a650513          	addi	a0,a0,1190 # 8a8 <digits>
 40a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50a:	34a70713          	addi	a4,a4,842 # 850 <malloc+0x112>
 ...
 594:	318b8b93          	addi	s7,s7,792 # 8a8 <digits>
 ...
 5e8:	26490913          	addi	s2,s2,612 # 848 <malloc+0x10a>
        while(*s != 0){
