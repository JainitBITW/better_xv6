...
void periodic()
{
  ...
  1e:	bf650513          	addi	a0,a0,-1034 # c10 <malloc+0xe6>
...
void slow_handler()
{
  ...
  5c:	bb850513          	addi	a0,a0,-1096 # c10 <malloc+0xe6>
  ...
  a2:	b7a50513          	addi	a0,a0,-1158 # c18 <malloc+0xee>
...
00000000000000dc <test0>:
{
  ...
  f2:	b6250513          	addi	a0,a0,-1182 # c50 <malloc+0x126>
 ...
 126:	b3ea8a93          	addi	s5,s5,-1218 # c60 <malloc+0x136>
        if (count > 0)
 ...
 17e:	aee50513          	addi	a0,a0,-1298 # c68 <malloc+0x13e>
 ...
 1a0:	adc50513          	addi	a0,a0,-1316 # c78 <malloc+0x14e>
...
00000000000001ae <foo>:
{
 ...
 1de:	a8658593          	addi	a1,a1,-1402 # c60 <malloc+0x136>
 1e2:	4509                	li	a0,2
...
00000000000001ee <test1>:
{
 ...
 202:	aba50513          	addi	a0,a0,-1350 # cb8 <malloc+0x18e>
 ...
 278:	a8450513          	addi	a0,a0,-1404 # cf8 <malloc+0x1ce>
 ...
 298:	a3450513          	addi	a0,a0,-1484 # cc8 <malloc+0x19e>
 29c:	00000097          	auipc	ra,0x0
 2a0:	7d6080e7          	jalr	2006(ra) # a72 <printf>
 2a4:	b7c5                	j	284 <test1+0x96>
        printf("test1 passed\n");
 2a6:	00001517          	auipc	a0,0x1
 2aa:	a9250513          	addi	a0,a0,-1390 # d38 <malloc+0x20e>
...
00000000000002b8 <test2>:
{
 ...
 2ce:	a7e50513          	addi	a0,a0,-1410 # d48 <malloc+0x21e>
 ...
 310:	954a8a93          	addi	s5,s5,-1708 # c60 <malloc+0x136>
            if (count > 0)
 ...
 32a:	a3250513          	addi	a0,a0,-1486 # d58 <malloc+0x22e>
 ...
 38e:	9e650513          	addi	a0,a0,-1562 # d70 <malloc+0x246>
 ...
 3b2:	9ea50513          	addi	a0,a0,-1558 # d98 <malloc+0x26e>
...
void test3()
{
 ...
 3de:	9ce50513          	addi	a0,a0,-1586 # da8 <malloc+0x27e>
 ...
 40c:	9b050513          	addi	a0,a0,-1616 # db8 <malloc+0x28e>
 ...
 424:	9c050513          	addi	a0,a0,-1600 # de0 <malloc+0x2b6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7f2:	66250513          	addi	a0,a0,1634 # e50 <digits>
 7f6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 8f6:	50670713          	addi	a4,a4,1286 # df8 <malloc+0x2ce>
 ...
 980:	4d4b8b93          	addi	s7,s7,1236 # e50 <digits>
 ...
 9d4:	42090913          	addi	s2,s2,1056 # df0 <malloc+0x2c6>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 b7a:	49290913          	addi	s2,s2,1170 # 1008 <freep>
  if(p == (char*)-1)
 b7e:	5afd                	li	s5,-1
 b80:	a895                	j	bf4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 b82:	00000797          	auipc	a5,0x0
 b86:	48e78793          	addi	a5,a5,1166 # 1010 <base>
 ...
 ba2:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ba4:	02071693          	slli	a3,a4,0x20
 ba8:	01c6d713          	srli	a4,a3,0x1c
